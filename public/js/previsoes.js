...
const latenciaSimulada = {
    geral: { cpu: 70, ram: 45, disco: 80 },
    "CTC-01": { cpu: 60, ram: 42, disco: 75 },
    "CTC-02": { cpu: 65, ram: 48, disco: 78 },
    "Regulador-01": { cpu: 55, ram: 40, disco: 72 }
};
...
document.addEventListener('DOMContentLoaded', function() {
    servidorSelect.addEventListener("change", atualizarDashboard);
