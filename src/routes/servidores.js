...
router.get("/pegarUsoTempoReal/:empresa/:servidorNome", servidorController.pegarUsoTempoReal);
router.get("/pegarUso/:empresa/:servidor", servidorController.pegarUso);
